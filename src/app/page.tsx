    ...
    <main className="flex-1 flex flex-col items-center justify-center min-h-screen px-6 sm:px-12 relative">
      ...
      <div className="relative z-10 max-w-4xl w-full flex flex-col items-center text-center space-y-8">
        ...
        <p className="text-lg md:text-xl text-[var(--ivory)] opacity-80 max-w-2xl font-light tracking-wide leading-relaxed">
          Building end-to-end unique AI products that are actually useful, with skill and passion.
        </p>
        ...
        <div className="pt-12 flex flex-col md:flex-row gap-6">
          ...
          >
            <span className="text-[var(--gold)] uppercase tracking-widest text-sm font-medium">My Work</span>
          ...
          >
            <span className="text-[var(--ivory)] opacity-80 group-hover:opacity-100 uppercase tracking-widest text-sm font-medium transition-opacity">About Me</span>
          </Link>
        </div>
      </div>
    </main>
